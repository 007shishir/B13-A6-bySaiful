...
const ToolsHeader = ({ productBtn, setProductBtn, selectedProducts }) => {
  return (
    <section className="bg-white py-12 sm:py-16">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <button className={`rounded-full border ${productBtn ? 'border-indigo-600 bg-white text-slate-700 hover:bg-slate-50' : 'bg-indigo-600 text-white hover:bg-indigo-600'} px-6 py-2.5 text-sm font-semibold `} onClick={() => setProductBtn(false)}>
