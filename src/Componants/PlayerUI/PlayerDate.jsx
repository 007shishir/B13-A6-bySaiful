...
const PlayerDate = ({ toolsPromise }) => {
    ...
    return (
        ...
        <div className="max-w-md mx-auto bg-white border border-slate-200 rounded-3xl shadow-[0_20px_50px_rgba(15,23,42,0.08)] overflow-hidden">
            <div className="relative bg-slate-50 p-6 sm:p-8">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h2 className="text-2xl font-semibold text-slate-900">AI Writing Pro</h2>
                        <p className="text-sm text-slate-500">Generate high-quality content, blogs, and marketing copy in seconds with advanced AI.</p>
                    </div>
                </div>
                ...
                <div className="space-y-3 mb-6">
                    <div className="flex items-center gap-3 text-slate-700">
                        <svg className="h-5 w-5 text-emerald-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9 16.17l-3.88-3.88a.75.75 0 1 0-1.06 1.06l4.41 4.41a.75.75 0 0 0 1.06 0l9.19-9.19a.75.75 0 1 0-1.06-1.06L9 16.17Z" fill="currentColor"/>
                        </svg>
